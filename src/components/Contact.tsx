...
export default function Contact() {
  ...
  const email = settings.emailAddress || contact.email
  const channels = [
    { Icon: MessageCircle, label: 'WhatsApp', valueKey: 'contact.whatsapp', href: settings.whatsappUrl || contact.whatsapp },
    { Icon: Mail, labelKey: 'contact.email', value: email, href: `mailto:${email}` },
    { Icon: AtSign, labelKey: 'contact.instagram', value: '@ainaka', href: settings.instagramUrl || contact.instagram },
  ]
