...
import { ClipboardList, LayoutDashboard, LogOut, Palette, Settings2, Users } from 'lucide-react'
...
type Tab = 'projects' | 'briefings' | 'content' | 'brand' | 'users'
